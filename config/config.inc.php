...
$_DVWA = array();
$_DVWA[ 'db_server' ]   = 'dbdvwa.mysql.database.azure.com';
$_DVWA[ 'db_database' ] = 'dvwa';
$_DVWA[ 'db_user' ]     = 'binhduc';
$_DVWA[ 'db_password' ] = 'Asaiduc@1910';
$_DVWA[ 'db_port']      = '3306';

# ReCAPTCHA settings
#   Used for the 'Insecure CAPTCHA' module
#   You'll need to generate your own keys at: https://www.google.com/recaptcha/admin
$_DVWA[ 'recaptcha_public_key' ]  = '6LfaKPYqAAAAAFYHpZEJ0JkPnXt8JIFrWOl-QFOF';
$_DVWA[ 'recaptcha_private_key' ] = '6LfaKPYqAAAAANh0-uGTy8gvtxh51MtDGAX-j6s5';
